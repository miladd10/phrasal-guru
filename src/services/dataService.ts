...
export type Category = 'phrasal' | 'idiom' | 'unit0' | 'unit2' | 'unit4' | 'unit6' | 'unit8' | 'unit10' | 'unit12' | 'unit14' | 'unit16' | 'unit18' | 'unit20' | 'unit22' | 'unit24' | 'unit26';
...
export async function enrichPhrasalVerb(rawText: string, category: Category = 'phrasal'): Promise<PhrasalVerb[]> {
  const response = await ai.models.generateContent({
    ...
    contents: `Parse this raw vocabulary list into JSON with fields: word, definition, example, phonetic (IPA), and translation (Persian).
    ...
    config: {
      ...
      responseSchema: {
        ...
        items: {
          ...
          required: ["word", "definition", "example", "phonetic", "translation"]
        }
      }
    }
  });
